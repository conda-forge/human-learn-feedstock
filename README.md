...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/human-learn-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11300&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/human-learn-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `human-learn` can be installed with:

```
conda install human-learn
```

It is possible to list all of the versions of `human-learn` available on your platform with:
